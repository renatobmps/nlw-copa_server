/*
  ...
  - You are about to drop the column `gamesId` on the `Guess` table. All the data in the column will be lost.
...
INSERT INTO "new_Guess" ("createAt", "firstTeamPoints", "id", "participansId", "secondTeamPoints") SELECT "createAt", "firstTeamPoints", "id", "participansId", "secondTeamPoints" FROM "Guess";
DROP TABLE "Guess";
